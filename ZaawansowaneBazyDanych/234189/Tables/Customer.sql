...
WITH (SYSTEM_VERSIONING = ON (HISTORY_TABLE=[234189].[CustomerHistory], DATA_CONSISTENCY_CHECK=ON));
...
CREATE NONCLUSTERED INDEX [IX_Customer_EmailAddress]
    ON [234189].[Customer]([EmailAddress] ASC);
